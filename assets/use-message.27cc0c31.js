import{i as co,E as mo,a as N,S as vo,p as Co,b as O,d as to,u as yo,t as Mo,y as Y,O as Oo,h as z,f,a0 as jo,a1 as So,n as _o,v as ao,s as w,g as p,w as uo,j as Lo,x as no,B as No,A as Vo,F as $o,G as n,o as eo,I as Ko,a2 as xo,J as po,a3 as Qo,a4 as Ao,N as qo,m as Jo,Q as Uo,a5 as Yo,a6 as Xo,a7 as go,a8 as Zo,a9 as oe}from"./index.54d44e10.js";function ee(o,a="default",x=[]){const t=o.$slots[a];return t===void 0?x:t()}const ho=Co("n-form-item");function re(o,{defaultSize:a="medium",mergedSize:x,mergedDisabled:i}={}){const t=co(ho,null);mo(ho,null);const g=N(x?()=>x(t):()=>{const{size:$}=o;if($)return $;if(t){const{mergedSize:W}=t;if(W.value!==void 0)return W.value}return a}),D=N(i?()=>i(t):()=>{const{disabled:$}=o;return $!==void 0?$:t?t.disabled.value:!1}),R=N(()=>{const{status:$}=o;return $||(t==null?void 0:t.mergedValidationStatus.value)});return vo(()=>{t&&t.restoreValidation()}),{mergedSizeRef:g,mergedDisabledRef:D,mergedStatusRef:R,nTriggerFormBlur(){t&&t.handleContentBlur()},nTriggerFormChange(){t&&t.handleContentChange()},nTriggerFormFocus(){t&&t.handleContentFocus()},nTriggerFormInput(){t&&t.handleContentInput()}}}var te=O("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`,[ao("vertical",{flexDirection:"row"},[O("button",[f("&:first-child:not(:last-child)",`
 ...
 display: flex;
 width: 100%;
 `),w("dashed",[p("border, state-border",{borderStyle:"dashed !important"})]),w("disabled",{cursor:"not-allowed",opacity:"var(--n-opacity-disabled)"})]),f("@keyframes button-wave-spread",{from:{boxShadow:"0 0 0.5px 0 var(--n-ripple-color)"},to:{boxShadow:"0 0 0.5px 4.5px var(--n-ripple-color)"}}),f("@keyframes button-wave-opacity",{from:{opacity:"var(--n-wave-opacity)"},to:{opacity:0}})]);const fe=Object.assign(Object.assign({},no.props),{color:String,textColor:String,text:Boolean,block:Boolean,loading:Boolean,disabled:Boolean,circle:Boolean,size:String,ghost:Boolean,round:Boolean,secondary:Boolean,tertiary:Boolean,quaternary:Boolean,strong:Boolean,focusable:{type:Boolean,default:!0},keyboard:{type:Boolean,default:!0},tag:{type:String,default:"button"},type:{type:String,default:"default"},dashed:Boolean,iconPlacement:{type:String,default:"left"},attrType:{type:String,default:"button"},bordered:{type:Boolean,default:!0},onClick:[Function,Array],internalAutoFocus:Boolean}),xe=to({name:"Button",props:fe,setup(o){const a=Y(null),x=Y(null),i=Y(!1);No(()=>{const{value:r}=a;r&&!o.disabled&&o.focusable&&o.internalAutoFocus&&r.focus({preventScroll:!0})});const t=Vo(()=>!o.quaternary&&!o.tertiary&&!o.secondary&&!o.text&&(!o.color||o.ghost||o.dashed)&&o.bordered),g=co(wo,{}),{mergedSizeRef:D}=re({},{defaultSize:"medium",mergedSize:r=>{const{size:c}=o;if(c)return c;const{size:S}=g;if(S)return S;const{mergedSize:e}=r||{};return e?e.value:"medium"}}),R=N(()=>o.focusable&&!o.disabled),$=r=>{var c;r.preventDefault(),!o.disabled&&R.value&&((c=a.value)===null||c===void 0||c.focus({preventScroll:!0}))},W=r=>{var c;if(!o.disabled&&!o.loading){const{onClick:S}=o;S&&Uo(S,r),o.text||(c=x.value)===null||c===void 0||c.play()}},Q=r=>{switch(r.code){case"Enter":case"NumpadEnter":if(!o.keyboard)return;i.value=!1}},C=r=>{switch(r.code){case"Enter":case"NumpadEnter":if(!o.keyboard||o.loading){r.preventDefault();return}i.value=!0}},U=()=>{i.value=!1},{inlineThemeDisabled:d,mergedClsPrefixRef:y,mergedRtlRef:k}=uo(o),H=no("Button","-button",be,de,o,y),s=$o("Button",k,y),G=N(()=>{const r=H.value,{common:{cubicBezierEaseInOut:c,cubicBezierEaseOut:S},self:e}=r,{rippleDuration:E,opacityDisabled:B,fontWeight:j,fontWeightStrong:I}=e,v=D.value,{dashed:_,type:M,ghost:A,text:F,color:u,round:X,circle:so,textColor:V,secondary:To,tertiary:bo,quaternary:zo,strong:Ho}=o,Bo={"font-weight":Ho?I:j};let h={"--n-color":"initial","--n-color-hover":"initial","--n-color-pressed":"initial","--n-color-focus":"initial","--n-color-disabled":"initial","--n-ripple-color":"initial","--n-text-color":"initial","--n-text-color-hover":"initial","--n-text-color-pressed":"initial","--n-text-color-focus":"initial","--n-text-color-disabled":"initial"};const Z=M==="tertiary",fo=M==="default",l=Z?"default":M;if(F){const m=V||u,P=m||e[n("textColorText",l)];h={"--n-color":"#0000","--n-color-hover":"#0000","--n-color-pressed":"#0000","--n-color-focus":"#0000","--n-color-disabled":"#0000","--n-ripple-color":"#0000","--n-text-color":P,"--n-text-color-hover":m?K(m):e[n("textColorTextHover",l)],"--n-text-color-pressed":m?ro(m):e[n("textColorTextPressed",l)],"--n-text-color-focus":m?K(m):e[n("textColorTextHover",l)],"--n-text-color-disabled":m||e[n("textColorTextDisabled",l)]}}else if(A||_){const m=V||u;h={"--n-color":"#0000","--n-color-hover":"#0000","--n-color-pressed":"#0000","--n-color-focus":"#0000","--n-color-disabled":"#0000","--n-ripple-color":u||e[n("rippleColor",l)],"--n-text-color":m||e[n("textColorGhost",l)],"--n-text-color-hover":m?K(m):e[n("textColorGhostHover",l)],"--n-text-color-pressed":m?ro(m):e[n("textColorGhostPressed",l)],"--n-text-color-focus":m?K(m):e[n("textColorGhostHover",l)],"--n-text-color-disabled":m||e[n("textColorGhostDisabled",l)]}}else if(To){const m=fo?e.textColor:Z?e.textColorTertiary:e[n("color",l)],P=u||m,oo=M!=="default"&&M!=="tertiary";h={"--n-color":oo?eo(P,{alpha:Number(e.colorOpacitySecondary)}):e.colorSecondary,"--n-color-hover":oo?eo(P,{alpha:Number(e.colorOpacitySecondaryHover)}):e.colorSecondaryHover,"--n-color-pressed":oo?eo(P,{alpha:Number(e.colorOpacitySecondaryPressed)}):e.colorSecondaryPressed,"--n-color-focus":oo?eo(P,{alpha:Number(e.colorOpacitySecondaryHover)}):e.colorSecondaryHover,"--n-color-disabled":e.colorSecondary,"--n-ripple-color":"#0000","--n-text-color":P,"--n-text-color-hover":P,"--n-text-color-pressed":P,"--n-text-color-focus":P,"--n-text-color-disabled":P}}else if(bo||zo){const m=fo?e.textColor:Z?e.textColorTertiary:e[n("color",l)],P=u||m;bo?(h["--n-color"]=e.colorTertiary,h["--n-color-hover"]=e.colorTertiaryHover,h["--n-color-pressed"]=e.colorTertiaryPressed,h["--n-color-focus"]=e.colorSecondaryHover,h["--n-color-disabled"]=e.colorTertiary):(h["--n-color"]=e.colorQuaternary,h["--n-color-hover"]=e.colorQuaternaryHover,h["--n-color-pressed"]=e.colorQuaternaryPressed,h["--n-color-focus"]=e.colorQuaternaryHover,h["--n-color-disabled"]=e.colorQuaternary),h["--n-ripple-color"]="#0000",h["--n-text-color"]=P,h["--n-text-color-hover"]=P,h["--n-text-color-pressed"]=P,h["--n-text-color-focus"]=P,h["--n-text-color-disabled"]=P}else h={"--n-color":u||e[n("color",l)],"--n-color-hover":u?K(u):e[n("colorHover",l)],"--n-color-pressed":u?ro(u):e[n("colorPressed",l)],"--n-color-focus":u?K(u):e[n("colorFocus",l)],"--n-color-disabled":u||e[n("colorDisabled",l)],"--n-ripple-color":u||e[n("rippleColor",l)],"--n-text-color":V||(u?e.textColorPrimary:Z?e.textColorTertiary:e[n("textColor",l)]),"--n-text-color-hover":V||(u?e.textColorHoverPrimary:e[n("textColorHover",l)]),"--n-text-color-pressed":V||(u?e.textColorPressedPrimary:e[n("textColorPressed",l)]),"--n-text-color-focus":V||(u?e.textColorFocusPrimary:e[n("textColorFocus",l)]),"--n-text-color-disabled":V||(u?e.textColorDisabledPrimary:e[n("textColorDisabled",l)])};let io={"--n-border":"initial","--n-border-hover":"initial","--n-border-pressed":"initial","--n-border-focus":"initial","--n-border-disabled":"initial"};F?io={"--n-border":"none","--n-border-hover":"none","--n-border-pressed":"none","--n-border-focus":"none","--n-border-disabled":"none"}:io={"--n-border":e[n("border",l)],"--n-border-hover":e[n("borderHover",l)],"--n-border-pressed":e[n("borderPressed",l)],"--n-border-focus":e[n("borderFocus",l)],"--n-border-disabled":e[n("borderDisabled",l)]};const{[n("height",v)]:lo,[n("fontSize",v)]:Eo,[n("padding",v)]:Io,[n("paddingRound",v)]:Fo,[n("iconSize",v)]:Do,[n("borderRadius",v)]:Ro,[n("iconMargin",v)]:Go,waveOpacity:Wo}=e,ko={"--n-width":so&&!F?lo:"initial","--n-height":F?"initial":lo,"--n-font-size":Eo,"--n-padding":so||F?"initial":X?Fo:Io,"--n-icon-size":Do,"--n-icon-margin":Go,"--n-border-radius":F?"initial":so||X?lo:Ro};return Object.assign(Object.assign(Object.assign(Object.assign({"--n-bezier":c,"--n-bezier-ease-out":S,"--n-ripple-duration":E,"--n-opacity-disabled":B,"--n-wave-opacity":Wo},Bo),h),io),ko)}),T=d?Ko("button",N(()=>{let r="";const{dashed:c,type:S,ghost:e,text:E,color:B,round:j,circle:I,textColor:v,secondary:_,tertiary:M,quaternary:A,strong:F}=o;c&&(r+="a"),e&&(r+="b"),E&&(r+="c"),j&&(r+="d"),I&&(r+="e"),_&&(r+="f"),M&&(r+="g"),A&&(r+="h"),F&&(r+="i"),B&&(r+="j"+xo(B)),v&&(r+="k"+xo(v));const{value:u}=D;return r+="l"+u[0],r+="m"+S[0],r}),G,o):void 0;return{selfElRef:a,waveElRef:x,mergedClsPrefix:y,mergedFocusable:R,mergedSize:D,showBorder:t,enterPressed:i,rtlEnabled:s,handleMousedown:$,handleKeydown:C,handleBlur:U,handleKeyup:Q,handleClick:W,customColorCssVars:N(()=>{const{color:r}=o;if(!r)return null;const c=K(r);return{"--n-border-color":r,"--n-border-color-hover":c,"--n-border-color-pressed":ro(r),"--n-border-color-focus":c,"--n-border-color-disabled":r}}),cssVars:d?void 0:G,themeClass:T==null?void 0:T.themeClass,onRender:T==null?void 0:T.onRender}},render(){const{mergedClsPrefix:o,tag:a,onRender:x}=this;x==null||x();const i=po(this.$slots.default,t=>t&&z("span",{class:`${o}-button__content`},t));return z(a,{ref:"selfElRef",class:[this.themeClass,`${o}-button`,`${o}-button--${this.type}-type`,`${o}-button--${this.mergedSize}-type`,this.rtlEnabled&&`${o}-button--rtl`,this.disabled&&`${o}-button--disabled`,this.block&&`${o}-button--block`,this.enterPressed&&`${o}-button--pressed`,!this.text&&this.dashed&&`${o}-button--dashed`,this.color&&`${o}-button--color`,this.secondary&&`${o}-button--secondary`,this.loading&&`${o}-button--loading`,this.ghost&&`${o}-button--ghost`],tabindex:this.mergedFocusable?0:-1,type:this.attrType,style:this.cssVars,disabled:this.disabled,onClick:this.handleClick,onBlur:this.handleBlur,onMousedown:this.handleMousedown,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},this.iconPlacement==="right"&&i,z(Qo,{width:!0},{default:()=>po(this.$slots.icon,t=>(this.loading||t)&&z("span",{class:`${o}-button__icon`,style:{margin:Ao(this.$slots.default)?"0":""}},z(qo,null,{default:()=>this.loading?z(Jo,{clsPrefix:o,key:"loading",class:`${o}-icon-slot`,strokeWidth:20}):z("div",{key:"icon",class:`${o}-icon-slot`,role:"none"},t)})))}),this.iconPlacement==="left"&&i,this.text?null:z(ne,{ref:"waveElRef",clsPrefix:o}),this.showBorder?z("div",{"aria-hidden":!0,class:`${o}-button__border`,style:this.customColorCssVars}):null,this.showBorder?z("div",{"aria-hidden":!0,class:`${o}-button__state-border`,style:this.customColorCssVars}):null)}});var ye=xe,pe={gapSmall:"4px 8px",gapMedium:"8px 12px",gapLarge:"12px 16px"};const ge=()=>pe,he={name:"Space",self:ge};var me=he;const ve=Object.assign(Object.assign({},no.props),{align:String,justify:{type:String,default:"start"},inline:Boolean,vertical:Boolean,size:{type:[String,Number,Array],default:"medium"},itemStyle:[String,Object],wrap:{type:Boolean,default:!0}});var Se=to({name:"Space",props:ve,setup(o){const{mergedClsPrefixRef:a,mergedRtlRef:x}=uo(o),i=no("Space","-space",void 0,me,o,a);return{rtlEnabled:$o("Space",x,a),mergedClsPrefix:a,margin:N(()=>{const{size:g}=o;if(Array.isArray(g))return{horizontal:g[0],vertical:g[1]};if(typeof g=="number")return{horizontal:g,vertical:g};const{self:{[n("gap",g)]:D}}=i.value,{row:R,col:$}=Xo(D);return{horizontal:go($),vertical:go(R)}})}},render(){const{vertical:o,align:a,inline:x,justify:i,itemStyle:t,margin:g,wrap:D,mergedClsPrefix:R,rtlEnabled:$}=this,W=Yo(ee(this));if(!W.length)return null;const Q=`${g.horizontal}px`,C=`${g.horizontal/2}px`,U=`${g.vertical}px`,d=`${g.vertical/2}px`,y=W.length-1,k=i.startsWith("space-");return z("div",{role:"none",class:[`${R}-space`,$&&`${R}-space--rtl`],style:{display:x?"inline-flex":"flex",flexDirection:o?"column":"row",justifyContent:["start","end"].includes(i)?"flex-"+i:i,flexWrap:!D||o?"nowrap":"wrap",marginTop:o?"":`-${d}`,marginBottom:o?"":`-${d}`,alignItems:a}},W.map((H,s)=>z("div",{role:"none",style:[t,{maxWidth:"100%"},o?{marginBottom:s!==y?U:""}:$?{marginLeft:k?i==="space-between"&&s===y?"":C:s!==y?Q:"",marginRight:k?i==="space-between"&&s===0?"":C:"",paddingTop:d,paddingBottom:d}:{marginRight:k?i==="space-between"&&s===y?"":C:s!==y?Q:"",marginLeft:k?i==="space-between"&&s===0?"":C:"",paddingTop:d,paddingBottom:d}]},H)))}});function $e(){const o=co(Zo,null);return o===null&&oe("use-message","No outer <n-message-provider /> founded. See prerequisite in https://www.naiveui.com/en-US/os-theme/components/message for more details. If you want to use `useMessage` outside setup, please check https://www.naiveui.com/zh-CN/os-theme/components/message#Q-&-A."),o}export{ye as _,$e as a,Se as b,ho as f,ee as g,re as u};
