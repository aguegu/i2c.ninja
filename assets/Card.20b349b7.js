import{E as D,B as t,y as f,G as l,H as n,aa as G,ab as I,ac as K,h as N,u as J,i as _,j as Q,k as $,M as U,m as i,O as v,ad as X,T as Y,q as y,a5 as Z}from"./index.0658b5a7.js";var oo={paddingSmall:"12px 16px 12px",paddingMedium:"19px 24px 20px",paddingLarge:"23px 32px 24px",paddingHuge:"27px 40px 28px",titleFontSizeSmall:"16px",titleFontSizeMedium:"18px",titleFontSizeLarge:"18px",titleFontSizeHuge:"18px",closeSize:"18px"};const eo=o=>{const{primaryColor:p,borderRadius:b,lineHeight:e,fontSize:s,cardColor:c,textColor2:d,textColor1:r,dividerColor:a,fontWeightStrong:g,closeColor:h,closeColorHover:u,closeColorPressed:x,modalColor:z,boxShadow1:C,popoverColor:S,actionColor:m}=o;return Object.assign(Object.assign({},oo),{lineHeight:e,color:c,colorModal:z,colorPopover:S,colorTarget:p,colorEmbedded:m,textColor:d,titleTextColor:r,borderColor:a,actionColor:m,titleFontWeight:g,closeColor:h,closeColorHover:u,closeColorPressed:x,fontSizeSmall:s,fontSizeMedium:s,fontSizeLarge:s,fontSizeHuge:s,boxShadow:C,borderRadius:b})},ro={name:"Card",common:D,self:eo};var to=ro,no=t([f("card",`
